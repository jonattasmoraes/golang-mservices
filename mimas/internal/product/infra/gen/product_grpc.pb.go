...
const (
	...
	ProductService_SaleProducts_FullMethodName   = "/product.ProductService/SaleProducts"
)
...
type ProductServiceClient interface {
	...
	SaleProducts(ctx context.Context, in *SaleProductsRequest, opts ...grpc.CallOption) (*SaleProductsResponse, error)
}
...
func (c *productServiceClient) SaleProducts(ctx context.Context, in *SaleProductsRequest, opts ...grpc.CallOption) (*SaleProductsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SaleProductsResponse)
	err := c.cc.Invoke(ctx, ProductService_SaleProducts_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProductServiceServer interface {
	...
	SaleProducts(context.Context, *SaleProductsRequest) (*SaleProductsResponse, error)
...
func (UnimplementedProductServiceServer) SaleProducts(context.Context, *SaleProductsRequest) (*SaleProductsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SaleProducts not implemented")
}
...
func _ProductService_SaleProducts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SaleProductsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProductServiceServer).SaleProducts(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProductService_SaleProducts_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).SaleProducts(ctx, req.(*SaleProductsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProductService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SaleProducts",
			Handler:    _ProductService_SaleProducts_Handler,
		},
	},
